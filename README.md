...
### 1. Install [RipperFox Firefox Add-on](https://github.com/Yama-K/RipperFoxExtension/releases/download/Release/RipperFox.xpi) (Just left click it, it should just install.) [Install from here](https://github.com/Yama-K/RipperFoxExtension/releases/tag/Release)
